 ...
 * Date  2019-04-03
 */
public abstract class BaseFuture<T extends BaseEntity> {
    ...
    public CompletableFuture<Integer> insert(T entity) {
        return CompletableFuture.supplyAsync(() -> getBaseService().insert(entity));
    }
    ...
    public CompletableFuture<Integer> insertSelective(T entity) {
        return CompletableFuture.supplyAsync(() -> getBaseService().insertSelective(entity));
    }
    ...
    public CompletableFuture<Integer> update(T entity) {
        return CompletableFuture.supplyAsync(() -> getBaseService().update(entity));
    }
    ...
    public CompletableFuture<Integer> updateSelective(T entity) {
        return CompletableFuture.supplyAsync(() -> getBaseService().updateSelective(entity));
    }
    ...
    public CompletableFuture<Integer> delete(T entity) {
        return CompletableFuture.supplyAsync(() -> getBaseService().delete(entity));
    }
    ...
    public CompletableFuture<Integer> deleteByPrimaryKey(Object key) {
        return CompletableFuture.supplyAsync(() -> getBaseService().deleteByPrimaryKey(key));
    }
    ...
    public CompletableFuture<Boolean> existsWithPrimaryKey(Object key) {
        return CompletableFuture.supplyAsync(() -> getBaseService().existsWithPrimaryKey(key));
    }
    ...
    public CompletableFuture<T> selectOne(T entity) {
        return CompletableFuture.supplyAsync(() -> getBaseService().selectOne(entity));
    }
    ...
    public CompletableFuture<T> selectByPrimaryKey(Object key) {
        return CompletableFuture.supplyAsync(() -> getBaseService().selectByPrimaryKey(key));
    }
    ...
    public CompletableFuture<Integer> selectCount(T entity) {
        return CompletableFuture.supplyAsync(() -> getBaseService().selectCount(entity));
    }
    ...
    public CompletableFuture<List<T>> findList(T entity, String pageNum, String pageSize) {
        return CompletableFuture.supplyAsync(() -> getBaseService().findList(entity, pageNum, pageSize));
    }
    ...
    public CompletableFuture<List<T>> findAllList(String pageNum, String pageSize) {
        return CompletableFuture.supplyAsync(() -> getBaseService().findAllList(pageNum, pageSize));
    }
    ...
    public CompletableFuture<List<T>> findSimpleListByAndCondition(T entity, String pageNum, String pageSize) {
        return CompletableFuture.supplyAsync(() -> getBaseService().findSimpleListByAndCondition(entity, pageNum, pageSize));
    }
    ...
    public CompletableFuture<List<T>> findListByAndCondition(T entity, String pageNum, String pageSize) {
        return CompletableFuture.supplyAsync(() -> getBaseService().findListByAndCondition(entity, pageNum, pageSize));
    }
    ...
    public CompletableFuture<List<T>> findSimpleListByORCondition(T entity, String pageNum, String pageSize) {
        return CompletableFuture.supplyAsync(() -> getBaseService().findSimpleListByORCondition(entity, pageNum, pageSize));
    }
    ...
    public CompletableFuture<List<T>> findListByORCondition(T entity, String pageNum, String pageSize) {
        return CompletableFuture.supplyAsync(() -> getBaseService().findListByORCondition(entity, pageNum, pageSize));
    }
