 ...
 **/
public class ProducerCompositeTask extends AbstractTask {

    public ProducerCompositeTask(String className, String description) {
    ...
    public void run() throws IOException, TemplateException {
        ...
        dataMap.put("CompositePackageName", ConfigUtil.getConfiguration().getPath().getComposite());
        ...
        String filePath = FileUtil.getSourcePath() + StringUtil.package2Path(ConfigUtil.getConfiguration().getPackageName()) + StringUtil.package2Path(ConfigUtil.getConfiguration().getPath().getComposite());
        String fileName = className + "Composite.java";
        // 生成Composite文件
        System.out.println("Generating " + fileName);
        FileUtil.generateToJava(FreemarketConfigUtils.TYPE_PRODUCER_COMPOSITE, dataMap, filePath + fileName);
    }
}
