...
public interface ${ClassName}Service extends BaseService<${ClassName}Entity> {
    ...
    List<${ClassName}Entity> find${ClassName}ByCondition(${ClassName}Entity ${ClassName?uncap_first});
     ...
     List<${ClassName}Entity> find${ClassName}ByCondition(${ClassName}Entity ${ClassName?uncap_first}, @PathVariable("pageNum") int pageNum, @PathVariable("pageSize") int pageSize);
